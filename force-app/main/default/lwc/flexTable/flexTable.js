...
const columns = [
    ...
    { label: 'Preço', fieldName: 'productNewPrice', editable: true, type: 'currency', typeAttributes : { currencyCode: 'BRL', minimumFractionDigits: 4, maximumFractionDigits: 4}, initialWidth: 80},
    { label: 'Preço atual', fieldName: 'productCurrentPrice', displayReadOnlyIcon: true, type: 'currency', typeAttributes : { currencyCode: 'BRL', minimumFractionDigits: 4,  maximumFractionDigits: 4}, initialWidth: 110 },
